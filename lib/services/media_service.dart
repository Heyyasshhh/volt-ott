...
class MediaService {
  ...
  String _shareText = "Check Out VOLT OTT";
  String _shareUrl = "https://butterflyott.com";

  String _referralText =
      "Hey! I just installed VOLT OTT and found the video content super entertaining. If you're signing up, make sure to use my code during checkout to get a special bonus! {code}";
