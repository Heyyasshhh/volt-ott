                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('UPCOMING SHOWS', style: AppTextStyles.displayTitle.copyWith(fontSize: 32)),
                            const SizedBox(height: 6),
                            Text('Coming soon', style: AppTextStyles.eyebrow.copyWith(color: AppColors.colorOrange)),
